...
public class SimpleBBQJEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<GrillCookingRecipe> boilingPotRecipes = recipeManager.getAllRecipesFor(SimpleBBQRegistry.GRILL_COOKING_RECIPE_TYPE);
        ...
        List<SeasoningRecipe> seasoningRecipes = recipeManager.getAllRecipesFor(SimpleBBQRegistry.SEASONING_RECIPE_TYPE);
        registration.addRecipes(SimpleBBQJEIRecipes.SEASONING, seasoningRecipes);
        List<SkeweringRecipe> skeweringRecipes = recipeManager.getAllRecipesFor(SimpleBBQRegistry.SKEWERING_RECIPE_TYPE);
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(SimpleBBQRegistry.GRILL_BLOCK_ITEM.getDefaultInstance(), SimpleBBQJEIRecipes.GRILL_COOKING, SimpleBBQJEIRecipes.CAMPFIRE_COOKING_ON_GRILL, SimpleBBQJEIRecipes.SEASONING);
        registration.addRecipeCatalyst(SimpleBBQRegistry.SKEWERING_TABLE_BLOCK_ITEM.getDefaultInstance(), SimpleBBQJEIRecipes.SKEWERING);
    }
}