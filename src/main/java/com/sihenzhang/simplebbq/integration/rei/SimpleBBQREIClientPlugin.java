...
public class SimpleBBQREIClientPlugin implements REIClientPlugin {
    ...
    public void registerCategories(CategoryRegistry registry) {
        ...
        registry.addWorkstations(skewering.getCategoryIdentifier(), EntryStacks.of(SimpleBBQRegistry.SKEWERING_TABLE_BLOCK_ITEM.get()));
        registry.addWorkstations(seasoning.getCategoryIdentifier(), EntryStacks.of(SimpleBBQRegistry.GRILL_BLOCK_ITEM.get()));
        registry.addWorkstations(grillCooking.getCategoryIdentifier(), EntryStacks.of(SimpleBBQRegistry.GRILL_BLOCK_ITEM.get()));
        registry.addWorkstations(campfireCookingOnGrill.getCategoryIdentifier(), EntryStacks.of(SimpleBBQRegistry.GRILL_BLOCK_ITEM.get()));
    }

    @Override
    public void registerDisplays(DisplayRegistry registry) {
        registry.registerRecipeFiller(SkeweringRecipe.class, SimpleBBQRegistry.SKEWERING_RECIPE_TYPE.get(), SkeweringDisplay::new);
        registry.registerRecipeFiller(SeasoningRecipe.class, SimpleBBQRegistry.SEASONING_RECIPE_TYPE.get(), SeasoningDisplay::new);
        registry.registerRecipeFiller(GrillCookingRecipe.class, SimpleBBQRegistry.GRILL_COOKING_RECIPE_TYPE.get(), GrillCookingDisplay::new);
